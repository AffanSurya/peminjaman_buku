        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <ul class="list-inline">
                    <li class="list-inline-item "><a href="https://www.instagram.com/affan_kg/" target="_blank">
                            <button type="button" class="btn btn-dark follow" fdprocessedid="6o3v0f">
                    ...
                    <li class="list-inline-item"><a href="https://www.facebook.com/affan.surya.37/" target="_blank">
                            <button type="button" class="btn btn-dark follow" fdprocessedid="yu2ija">
                                <div class="d-flex justify-content-center align-content-center">
                    ...
                    <li class="list-inline-item"><a href="https://github.com/AffanSurya" target="_blank">
                            <button type="button" class="btn btn-dark follow" fdprocessedid="yu2ija">
                                <div class="d-flex justify-content-center align-content-center">
...
<script src="http://localhost/peminjaman_buku/public/js/bootstrap.js"></script>
